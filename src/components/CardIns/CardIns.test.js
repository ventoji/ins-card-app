...
describe('Card component', () => {
    ...
    it('should be defined', () => {
        ...
        expect(container.querySelectorAll('div')[1]).toHaveClass('ins-card__image-container');
        expect(container.querySelectorAll('div')[2]).toHaveClass('ins-card__description');
    });
    ...
    it('should render card with provided details', () => {
        const { getByText, container } = render(<CardIns {...CARD_DETAILS} />);
